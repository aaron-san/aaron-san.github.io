        ...
        <div className="md:flex items-center gap-4 shadow-md p-2">
          ...
          <div className="mx-auto my-4 max-w-[400px] text-slate-600 text-center">
            ...
            <div className="mx-auto mt-2 border-stone-300 border-b w-fit text-lg italic">
              {" "}
              <b>financial analyst, data analyst, </b> and{" "}
              <b>investment professional</b>
            </div>
            <div className="sm:block inline mt-4 w-fit">
              <div className="inline mr-1">I specialize in</div>
              <a
                href="https://aaron-san.github.io/cfa-notes/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline text-600 italic"
              >
                financial analysis
              </a>
              ...
              .
              <div className="sm:block inline mx-auto w-fit">
                <span>I have experience in finance and have passed all</span>{" "}
                <a
