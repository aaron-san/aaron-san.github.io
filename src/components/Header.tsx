...
const Header = () => {
  ...
  return (
    <header>
      <div className="top-0 z-10 sticky flex bg-gradient-to-br from-stone-800 to-stone-700 p-3">
      ...
      <NavLink to="./contact"><div className="cursor-pointer text-sm font-bold uppercase tracking-widest py-2 w-full h-8 bg-green-200 text-center text-green-800 hover:bg-green-100 transition">Hire Me!</div></NavLink>
    </header>
  );
};
